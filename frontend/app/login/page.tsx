    ...
    <main className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-8 py-16">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          <h2 className="font-display text-3xl mb-8">Log in</h2>
          ...
          <input
            ...
            className="w-full mb-8 px-0 py-2 bg-transparent border-0 border-b border-line focus:border-forest outline-none"
            required
          />
